...
export class ReportingEpisodesCount extends Action {
    constructor() {
        super();
        this.name = "reportingEpisodesCount";
        this.description = "reportingEpisodesCount";
        this.inputs = {
    ...
    async run({ params }: { params: ParamsFrom<ReportingEpisodesCount> }) {
